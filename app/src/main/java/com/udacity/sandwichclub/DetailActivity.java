...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout alsoKnownAsLl = findViewById(R.id.also_known_tv);
        TextView placeOfOriginTv = findViewById(R.id.origin_tv);
        TextView descriptionTv = findViewById(R.id.description_tv);
        LinearLayout ingredientsLl = findViewById(R.id.ingredients_tv);
        ...
        if(sandwich.getAlsoKnownAs() != null) {
            for (String knownAs : sandwich.getAlsoKnownAs()) {
                ...
                textView.setText(knownAs);
                alsoKnownAsLl.addView(textView);
            }
        }
